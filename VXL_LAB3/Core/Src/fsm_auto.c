...
void updateCurrentTimerValues() {
    ...
    switch (status1) {
        ...
        case AUTO_YELLOW1:
            ...
            break;
        default:
            current_timer_value1 = 0; // Default to 0 if not in an active state
            break;
    }
    ...
    switch (status2) {
        ...
        case AUTO_YELLOW2:
            ...
            break;
        default:
            current_timer_value2 = 0; // Default to 0 if not in an active state
            break;
    }
}
...
void fsmAuto() {
    ...
    switch (status2) {
    	...
    	case AUTO_GREEN2:
    	     ...
    	     SEGvalue2 = (getRemainingTime(1) / 1000) + 1;
